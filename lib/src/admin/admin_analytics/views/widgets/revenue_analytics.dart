...
class RevenueAnalytics extends ConsumerWidget {
  const RevenueAnalytics({super.key});
    ...
    return  Container(
      ...
      margin: const EdgeInsets.only(left: 20, right: 20),
                          ...
                          child: GridView.builder(
                            ...
                            itemCount: revenueAnalyticsData.length,
                            itemBuilder: (context, index) {
                              return _revenueAnalytics(
                                  revenueAnalyticsData[index]);
                            },
                          ),
                        );
  }
...
Widget _revenueAnalytics(AdminSubscriptionModel subscription) {
  return InkWell(
    child: Container(
      width: 230,
