...
class SubscriptionTrendChart extends StatefulWidget {
  const SubscriptionTrendChart({super.key});

  @override
  State<SubscriptionTrendChart> createState() => _SubscriptionTrendChartState();
}

class _SubscriptionTrendChartState extends State<SubscriptionTrendChart> {
