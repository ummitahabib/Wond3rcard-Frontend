...
import 'package:wond3rcard/src/admin/common/widgets/admin_side_nav.dart';
import 'package:wond3rcard/src/profile/data/profile_controller/profile_controller.dart';
import 'package:wond3rcard/src/utils/size_constants.dart';
import 'package:wond3rcard/src/utils/ui_data.dart';
import 'package:wond3rcard/src/utils/wonder_card_colors.dart';

class AdminDashBoardDesktop extends StatefulHookConsumerWidget {
  const AdminDashBoardDesktop({super.key, this.isTabView = false, this.child});
  final bool isTabView;
  final Widget? child;

  @override
  _AdminDashBoardDesktopState createState() => _AdminDashBoardDesktopState();
}

class _AdminDashBoardDesktopState extends ConsumerState<AdminDashBoardDesktop> {
  ...
  Widget build(BuildContext context) {
    ...
    final navItems = adminNavItems(context);

    void updateSubItem(AdminNavItem mainItem, AdminNavItem subItem) {
      setState(() {
    ...
    void onSubItemTap(AdminRouteMenuItem subItem) {
