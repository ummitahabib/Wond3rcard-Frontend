...
//     final cardData = ref.watch(getCardProvider(authToken!));
...
//                       ? Image.network("${card.cardPictureUrl}", height: 150)
//                       : Icon(Icons.image, size: 100),
//                 ),
//                 SizedBox(height: 10),
//                 Text("Name: ${card.firstName} ${card.lastName}", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
...
//                     ? Image.network("${card.cardCoverUrl}", height: 100)
//                     : Container(),
//               ],
//             ),
//           );
