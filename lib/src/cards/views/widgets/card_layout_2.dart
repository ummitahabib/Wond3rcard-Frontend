...
class CardLayout2 extends StatefulHookConsumerWidget {
  final Function(String) onLayoutSelected;

  const CardLayout2({super.key, required this.onLayoutSelected});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _CardLayout2State();
}
