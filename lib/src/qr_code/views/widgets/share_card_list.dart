...
class _ShareCardListState extends ConsumerState<ShareCardList> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomAppBar(leading: const SizedBox(), title: cardsText),
      body: Padding(
        ...
        child: Container(
          ...
          child: ListView.builder(
            shrinkWrap: true,
            itemCount: cardController!.getCardsResponse?.payload?.cards?.length,
                ...
                children: [
                  Column(
                    children: [
                      Padding(
                        padding: const EdgeInsets.symmetric(
                            vertical: size8, horizontal: size19,),
