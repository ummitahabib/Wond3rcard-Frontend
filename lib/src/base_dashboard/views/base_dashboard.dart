...
class _BaseDashBoardState extends ConsumerState<BaseDashBoard> {
  ...
  Widget build(BuildContext context) {
    ...
    final Map<int, Widget> widgetMap = {
      UserRole.unknown.getValue(): Container(),
      UserRole.customer.getValue(): Container(),
      UserRole.admin.getValue(): Container(),
      UserRole.moderator.getValue(): Container(),
    };
    return RoleBasedAccessWidget(
      userRole: getUserRoleFromString(
        authProvide.profileData!.payload.user.userRole,
      ),
      widgetMap: widgetMap,
    );
  }
